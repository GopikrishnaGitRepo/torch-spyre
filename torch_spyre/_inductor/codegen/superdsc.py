...
def parse_op_spec(op_spec: OpSpec) -> tuple["SDSCSpec", "dict"]:
    ...
    is_fp32todl16 = op_spec.op == "fp32todl16"

    if (is_non_identity_dtype_op or is_fp32todl16) and op_stick_dim is None:
        input_stick_sym = Symbol(INPUT_DIM_LABELS[ndim])
        sdsc_iteration_space[input_stick_sym] = op_spec.args[0].device_dtype.elems_per_stick()
